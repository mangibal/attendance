...
public class CutiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        btnBackCuti.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void requestAttend(final View view) {
        ...
        String idStatus = sharedPrefManager.getSPLeave();
...
//                                    Toast.makeText(mContext, "Login Berhasil", Toast.LENGTH_SHORT).show();
                                    ...
                                    sharedPrefManager.saveSPBooleanCuti(SharedPrefManager.SP_LEAVE, true);
...
//                                    Toast.makeText(mContext, error_message, Toast.LENGTH_SHORT).show();
    ...
    private boolean validate() {
        ...
        whatsappIntent.putExtra(Intent.EXTRA_TEXT, "Status : Cuti\n" +
        ...
        try {
            ...
            Toast.makeText(CutiActivity.this, "Whatsapp have not been installed.", Toast.LENGTH_SHORT).show();
        }
    ...
    private void onFinishDate() {
        edtDateTo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(CutiActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    private void init() {
        btnBackCuti = findViewById(R.id.btn_back_cuti);
        edtLocation = findViewById(R.id.edt_lokasi_cuti);
        edtDateFrom = findViewById(R.id.edt_mulai_cuti);
        edtDateTo = findViewById(R.id.edt_selesai_cuti);
        edtKeterangan = findViewById(R.id.edt_keterangan_cuti);
        imageView = findViewById(R.id.img_cuti);
        submitButton = findViewById(R.id.btn_submit_cuti);
    }
